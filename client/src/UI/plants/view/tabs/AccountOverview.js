...
const AccountOverview = ({ data, warehouseOptions, onUpdate }) => {
    const { gstNo, phoneNumber, address, state, city, pinCode, userName: adminName, gstProof: gstproof, departmentName, emailid, createdDateTime,
        customertype, loading } = data
        ...
        <>
            <div className='app-view-info'>
                ...
                <div className='row half-stretch'>
                    ...
                    <div className='input-container'>
                        <InputValue size='smaller' value='Pincode' />
                ...
                <div className='input-container'>
                    ...
                    <InputValue size='large' value={dayjs(createdDateTime).format(DATEFORMAT)} />
                </div>
            </div>
        </>
    )
