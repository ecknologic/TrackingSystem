...
const BlocksComponent = ({ color }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24">
        <g fill={color} fillRule="nonzero" stroke="#5C63AB">
            <path strokeWidth=".5" d="M17.66 12.46H7.34a.57.57 0 01-.57-.57V1.57c0-.31.25-.57.57-.57h10.32c.32 0 .57.26.57.57V11.9c0 .32-.25.57-.57.57zM7.9 11.32h9.18V2.15H7.9v9.17z" />
            <path strokeWidth=".3" d="M14.22 5.59h-3.44a.57.57 0 01-.57-.58V1.57c0-.31.25-.57.57-.57h3.44c.32 0 .57.26.57.57v3.44c0 .32-.25.58-.57.58zm-2.87-1.15h2.3v-2.3h-2.3v2.3z" />
            <path strokeWidth=".4" d="M12.5 22.78H1.6a.57.57 0 01-.56-.57V11.89c0-.32.25-.57.57-.57H12.5c.32 0 .57.25.57.57v10.32c0 .32-.25.57-.57.57zM2.18 21.64h9.75v-9.18H2.18v9.18z" />
            <path strokeWidth=".3" d="M8.49 15.9H5.05a.57.57 0 01-.57-.57v-3.44c0-.32.25-.57.57-.57h3.44c.31 0 .57.25.57.57v3.44c0 .32-.26.57-.57.57zm-2.87-1.14h2.3v-2.3h-2.3v2.3z" />
            <path strokeWidth=".5" d="M23.4 22.78H12.5a.57.57 0 01-.57-.57V11.89c0-.32.25-.57.57-.57h10.9c.3 0 .56.25.56.57v10.32c0 .32-.25.57-.57.57zm-10.33-1.14h9.75v-9.18h-9.75v9.18z" />
            <path strokeWidth=".3" d="M19.95 15.9h-3.44a.57.57 0 01-.57-.57v-3.44c0-.32.26-.57.57-.57h3.44c.32 0 .58.25.58.57v3.44c0 .32-.26.57-.58.57zm-2.86-1.14h2.29v-2.3h-2.3v2.3z" />
        </g>
    </svg>
)
