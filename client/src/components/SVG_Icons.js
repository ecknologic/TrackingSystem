...
const ArrowSvg = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="18">
        <path fill="#0062FF" fillRule="evenodd" d="M.34 9.75a1 1 0 01-.1-1.4l7-8A1 1 0 018 0a1 1 0 01.82.43l6.93 7.91a1 1 0 11-1.5 1.32L9 3.67V17a1 1 0 01-.88 1H8a1 1 0 01-1-1V3.65l-5.25 6a1 1 0 01-1.3.18z" />
    </svg>
);
const CrossSvg = () => (
...
const PlusSvg = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18">
        <path fill="#0062FF" fillRule="evenodd" d="M10 8h7a1 1 0 010 2h-7v7a1 1 0 01-2 0v-7H1a1 1 0 010-2h7V1a1 1 0 012 0v7z" />
    </svg>
);
const DDownSvg = () => (
